                    ...
                    <div className="p-6 flex items-center gap-6 group">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`px-6 py-4 rounded-[1.5rem] font-black text-sm flex flex-col items-center gap-1 transition-all ${canAfford ? 'bg-emerald-500 text-white hover:bg-emerald-600 shadow-lg shadow-emerald-500/20 active:scale-95' : 'bg-slate-50 text-slate-300'}`}
                        >
